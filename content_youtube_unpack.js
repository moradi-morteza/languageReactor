    ...
    155: function(e, t, n) {
        ...
        !async function() {
            if (window == top) {
                ...
                e.setAttribute("src", chrome.runtime.getURL("pageScript_lly.min.js")), (document.head || document.documentElement).appendChild(e), e.remove()
            }
        }()
    },
    66: function(e, t, n) {
        ...
        n.d(t, "a", (function() {
            ...
            if (e.topic) {
                ...
                var r;
                e.topic.startsWith("LR_PS_") && (r = e, window.postMessage(r, "*"))
            }
